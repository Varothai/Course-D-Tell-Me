...
import { User, Home, MessageCircleQuestion, GraduationCap } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function NavBar() {
  ...
  return (
    <nav className="border-b bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-md">
